...
train_batches = ImageDataGenerator(preprocessing_function = None).flow_from_directory(directory=r'C:\Users\gabri\Documents\edible-plants\allplants\train',target_size=(224,224),classes=['edible_plants','poisonous_plants'],batch_size=10)
print(train_batches)
valid_batches = ImageDataGenerator(preprocessing_function = None).flow_from_directory(directory=r'C:\Users\gabri\Documents\edible-plants\allplants\validation',target_size=(224,224),classes=['edible_plants','poisonous_plants'],batch_size=10)
test_batches = ImageDataGenerator(preprocessing_function = None).flow_from_directory(directory=r'C:\Users\gabri\Documents\edible-plants\allplants\test',target_size=(224,224),classes=['edible_plants','poisonous_plants'],batch_size=10)
...
# conv_base.add(Conv2D(32,(3,3),activation = 'relu',input_shape=(224,224,3)))

# conv_base.add(Activation('relu'))
